...
led_wifi_orange_flashing() {
    /sbin/uci set system.red.default='1'
    /sbin/uci set system.red.trigger='heartbeat'
    /sbin/uci set system.green.default='1'
    /sbin/uci set system.green.trigger='heartbeat'
    uci_commit_reload
}
